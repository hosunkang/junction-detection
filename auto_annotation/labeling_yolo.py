...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class == "box":
                labels.append([left, top, right, bottom, 0])
            elif predicted_class == "in_junc":
                labels.append([left, top, right, bottom, 1])
            elif predicted_class == "out_junc":
                labels.append([left, top, right, bottom, 2])
